...
# with millions of declared rows). These bounds are deliberately generous
# for any real finite rational system this repository's own examples use,
# not tuned to a specific deployment.
MAX_RATIONAL_CHARS = 100_000
