...
- that coupled parallel composition preserves anything — no preservation candidate exists for it at all, in either this repository or `veribound-fce`'s design documentation.
