...
- `refinement_witness_composition_probe.py`, `refinement_witness_a4_e0_counterexample_search.py` — (A4)/(E0)-composability: probed, not proved (26-case systematic search, 0 counterexamples so far). See `docs/design/REFINEMENT_WITNESS_COMPOSITION_STATUS.md`.
